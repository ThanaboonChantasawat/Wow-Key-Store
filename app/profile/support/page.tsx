...
export default function CustomerSupportPage() {
      ...
      <div className="container mx-auto px-4 py-12">
        <Card>
          <CardContent className="p-8 text-center">
            <p className="text-gray-600 mb-4">กรุณาเข้าสู่ระบบเพื่อดูข้อความ</p>
            <Link href="/support">
              <Button className="bg-[#ff9800] hover:bg-[#e08800]">
                กลับไปหน้าติดต่อทีมงาน
              </Button>
            </Link>
          </CardContent>
        </Card>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-6">
        <Link href="/profile" className="inline-flex items-center gap-2 text-[#ff9800] hover:underline mb-4">
          <ArrowLeft className="w-4 h-4" />
          กลับไปโปรไฟล์
        </Link>
        <h1 className="text-3xl font-bold text-[#292d32] mb-2">ข้อความของฉัน</h1>
